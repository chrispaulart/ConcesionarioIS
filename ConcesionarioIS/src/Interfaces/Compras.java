...
public class Compras extends javax.swing.JInternalFrame {
    ...
    void aumentarstock(String codi, String can) {
        ...
        desfinal = Integer.parseInt(cap) + aum;
    ...
    void venta() {
        String InsertarSQL = "INSERT INTO COMPRAS (ID_COMP,CED_PRO_COMP,CED_EJEC_COMP,FEC_COM,TOTAL_COMP) VALUES (?,?,?,?,?)";
    ...
    void detallefactura() {
        for (int i = 0; i < tbdet.getRowCount(); i++) {
            String InsertarSQL = "INSERT INTO COMPRAS_DETALLE(ID_COMP_DC,ID_VEH_DC,CANTIDAD_C,COSTO_U_VEH_C,COSTO_TOTAL_C) VALUES (?,?,?,?,?)";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("COMPRAS CONSECIONARIO RCC");
        ...
        jLabel11.setText("Cod. Responsable:");
        ...
        jLabel9.setText("C.I. Responsable:");
...
// TODO add your handling code here:
    if ((txtcodv.getText().equals("")) || (txtsubtotal.getText().equals(""))) {
        ...
        for (int i = 0; i < Compras.tbdet.getRowCount(); i++) {
            capcod = Compras.tbdet.getValueAt(i, 0).toString();
            capcan = Compras.tbdet.getValueAt(i, 3).toString();
