 ...
 */
public class proovedor extends javax.swing.JInternalFrame {
    ...
    {
        String[]titulos={"Cedula","Nombre","Apellido","Telefono","Email"} ;  
        String []Registros= new String[5];
        modelo=new DefaultTableModel(null,titulos);
        String Sql="SELECT * FROM PROVEEDORES WHERE CONCAT(ID_PRO,NOM_PRO,APE_PRO) LIKE '%"+valor+"%'";
        ...
        try {
             ...
             while(rs.next())
             {
                 ...
                 Registros[4]=rs.getString("EMAIL_PRO");    
                 modelo.addRow(Registros);
             } 
             tbclientes.setModel(modelo);
        } catch (SQLException ex) {
            Logger.getLogger(proovedor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
// TODO add your handling code here:
    ...
    try {
        ...
        else
        {
         ...
         Compras.txtcedcli.setDisabledTextColor(Color.blue);
         Compras.txtcedcli.setText(cedcli);
         Compras.txtnomape.setDisabledTextColor(Color.blue);
         Compras.txtnomape.setText(nomcli+"   "+apecli);
         Compras.txttelf.setDisabledTextColor(Color.blue);
         Compras.txttelf.setText(telcli);
         Compras.txtcedvend.setText("Administrador");
         Compras.txtcodv.setText("VEND001");
         this.dispose();
